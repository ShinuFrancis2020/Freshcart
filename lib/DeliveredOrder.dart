...
{
  @override
  _DeliveredOrder createState() =>_DeliveredOrder ();
}
class _DeliveredOrder  extends State <DeliveredOrder > {
  ...
  void myOrders() async{
    var url=Prefmanager.baseurl+'/Purchase/groupedmyorders?count='+count.toString()+'&page='+page.toString()+'&status='+'Delivered';
      ...
      body:SafeArea(
        ...
        Column(
            children: [
                    ...
                    children: [
                      ...
                      GestureDetector(
                        child: Container(
                            alignment:Alignment.center,
                            width:MediaQuery.of(context).size.width/4,
                            child:Text("Order History",style:TextStyle(color:Colors.green,fontWeight:FontWeight.bold))
                        ),
                        onTap: () {
                          Navigator.pushReplacement(context, new MaterialPageRoute(builder: (
              ...
              orders.isEmpty?
              Center(child: Text("No order history found",style:TextStyle(fontWeight: FontWeight.bold)))
                                                                ...
                                                                List.generate(orders[index]['orderdata'][p]['product'].length,(k) {
                                                                  return Column(
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                            children:[
                                                                              orders[index]['orderdata'][p]['totalprice']!=null?

...
{
  final details;
  CartOrder(this.details);
  @override
  _CartOrder  createState() =>_CartOrder ();
}
class _CartOrder extends State <CartOrder> {
                        ...
                        FlatButton(
                          ...
                          onPressed: () {
                            if (_formKey.currentState.validate()) {
                              ...
                              Navigator.push(context,new MaterialPageRoute(builder: (context)=>new DeliveryaddressOrder(widget.details['product']["_id"],widget.details['quantity'])));
                            }
                          },
                        ),
                        SizedBox(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Quantity:'+widget.details['quantity'].toString(),
  ...
  void senddata() async {
    try{
      ...
      Map data={
        'x-auth-token': token,
        'product':widget.details['product']['_id'],
        'quantity':widget.details['quantity'].toString(),
        'state':state,
        'city':city,

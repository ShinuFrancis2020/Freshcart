...
class viewcityproducts extends StatefulWidget {
  final sellerid,id,name;
  viewcityproducts(this.sellerid,this.id,this.name);
  @override
...
//print('/product/getbyseller?city='+widget.id+'&sellerid='+widget.sellerid+'&count='+count.toString()+'&page='+page.toString());
    var url = Prefmanager.baseurl+'/product/getbyseller?city='+widget.id+'&sellerid='+widget.sellerid+'&count='+count.toString()+'&page='+page.toString();
  ...
  Widget build(BuildContext context) {
    return new WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          elevation: 0.0,
          title: Text('View products'+" ("+widget.name+")"
          ),
